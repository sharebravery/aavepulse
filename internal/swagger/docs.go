...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/schema.Overview"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.Reserve"
                                            }
                                        }
                                    }
                                }
        ...
        "/api/v1/defi/reserves/{id}/snapshots": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/schema.ReserveSnapshot"
                                            }
                                        }
                                    }
                                }
